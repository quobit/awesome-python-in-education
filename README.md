...
* [pythonroom](https://www.tynker.com/middle-school/coding-curriculum/python-511?src=pythonroom/)
...
* [BlockPy](https://think.cs.vt.edu/blockpy/) - web-based Python environment that lets you work with blocks, text, or both.
* [Edublocks](https://edublocks.org/) - Making the transition from Scratch to Python easier.
* [Python Lectures](https://github.com/rajathkmp/Python-Lectures) - IPython Notebooks to learn Python.
...
* [Programming with Python](http://swcarpentry.github.io/python-novice-inflammation/) - from [Software Carpentry](https://software-carpentry.org/)
...
* [Learn Python](https://www.learnpython.dev/) - Introduction and Intermediate Python, recorded for Frontend Masters by Nina Zakharenko.
...
* [TheNewBoston Flask Series](https://www.youtube.com/watch?v=ZVGwqnjOKjk&list=PL6gx4Cwl9DGDi9F_slcQK7knjtO8TUvUs)
...
* [HackerRank Challenges](https://www.hackerrank.com/domains/python?filters%5Bsubdomains%5D%5B%5D=py-introduction)
* [PyBites](https://pybit.es/) - [PyBites Code Challenges Platform](https://codechalleng.es/)
...
* [Python Challenges](https://www.101computing.net/category/python-challenges/)
* [Code & Conquer](https://www.codeandconquer.co/)
...
* [Python is Now the Most Popular Introductory Teaching Language at Top U.S. Universities](https://cacm.acm.org/blogs/blog-cacm/176450-python-is-now-the-most-popular-introductory-teaching-language-at-top-u-s-universities/fulltext) by Philip Guo (Communications of the ACM)
...
* [Full Stack Python](https://www.fullstackpython.com/table-of-contents.html) - [(best python resources)](https://www.fullstackpython.com/best-python-resources.html) - [(learning programming)](https://www.fullstackpython.com/learning-programming.html)
...
* [Python Patterns](https://python-patterns.guide/) - by Brandon Rhodes ([repo](https://github.com/brandon-rhodes/python-patterns))
...
* [Anti-Patterns in Python Programming](https://lignos.org/py_antipatterns/)
...
* [Python Lessons](https://teachwithict.weebly.com/python.html) - 6 lessons from teachwithict
...
* StackOverflow: [tag python](https://stackoverflow.com/questions/tagged/python) - [community website](https://sopython.com/)
...
* [Skulpt](http://skulpt.org/) - Skulpt is an entirely in-browser implementation of Python 2.X (!)
...
* [FoxDot](https://foxdot.org/) - Live Coding Music with Python & SuperCollider
...
* [VPython](https://vpython.org/) - 3D programming
...
* [Panda3D](https://www.panda3d.org/) - game engine and framework for 3D rendering
...
* [Jappy](https://github.com/somosazucar/Jappy) - the app powering the https://educa.juegos/ collaborative coding platform
...
* [IPython widgets](https://github.com/jupyter-widgets/ipywidgets)
* [lolviz](https://github.com/parrt/lolviz) - data-structure visualization tool for lists of lists, lists, dictionaries
* [nbgrader](https://nbgrader.readthedocs.io/en/stable/) - nbgrader is a tool that facilitates creating and grading assignments in the Jupyter notebook.
...
* [PixieDebugger](https://medium.com/codait/the-visual-python-debugger-for-jupyter-notebooks-youve-always-wanted-761713babc62) - The Visual Python Debugger for Jupyter Notebooks You’ve Always Wanted.
...
* [IPythonBlocks](http://www.ipythonblocks.org/)
...
* [VIM](https://www.vim.org/) with [Python plugins](https://realpython.com/vim-and-python-a-match-made-in-heaven/)
* [Emacs](https://www.gnu.org/software/emacs/) with [Python plugins](https://realpython.com/emacs-the-best-python-editor/)
* [Sublime Text 3](http://www.sublimetext.com/3) with [Python plugins](https://realpython.com/setting-up-sublime-text-3-for-full-stack-python-development/)
...
* [Python Linter Online](https://pythonbuddy.com/) - Live Syntax Checking Using Pylint while Running Python
* [PyTA](https://github.com/pyta-uoft/pyta) - static code analysis to help students find and fix common coding errors
* [coala](https://coala.io/) - linting and fixing code
...
* [Weekly Python Chat](https://www.pythonchat.com/) - Weekly live video chats about Python, teaching, open source, and more
...
* [A one-day mini-conference about Python in Education](https://2016.pyconuk.org/teachers/) (PyConUK 2016)
* [PyVideo tag 'education'](https://pyvideo.org/tag/education/)
...
* [Teaching Python: The Hard Parts](https://pyvideo.org/pycon-us-2016/elana-hashman-teaching-python-the-hard-parts-pycon-2016.html) - PyCon 2016
...
* [Build applications in Python the antitextbook](https://github.com/thewhitetulip/build-app-with-python-antitextbook)
...
* [Black Hat Python. Python Programming for Hackers and Pentesters](https://nostarch.com/blackhatpython)
...
* [Pro Python System Administration](https://www.apress.com/us/book/9781430226055) (2010)
...
* [The micro:bit Foundation](https://microbit.org/)
* [BBC micro:bit MicroPython](https://microbit-micropython.readthedocs.io/en/latest/)
* [Microbit Python Playground](https://python.microbit.org/v/1.1)
